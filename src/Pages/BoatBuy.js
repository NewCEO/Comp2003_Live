...
export default function BoatId() {
    ...
    function handlePurchase() {
        window.location.href = 'https://checkout.stripe.com/c/pay/cs_test_a113qr5IaD1IMXd6PM6LaTeATCERAevHfmPtLHuXs9dg3Za7E4OSCnxht8#fidkdWxOYHwnPyd1blpxYHZxWjA0SH9LckFPaUhVc09CNlxQVGw2XU5QcnZVSjF1NTVNVFJ2MF0wM0FyVVR0QkpCS3JuMTQ3Y39NS1BrSTNPQG1DTzY1PHc9cG1wS3BgZGg1RkpCT2Bgb1ZINTVhQVwyalJsMycpJ2N3amhWYHdzYHcnP3F3cGApJ2lkfGpwcVF8dWAnPyd2bGtiaWBabHFgaCcpJ2BrZGdpYFVpZGZgbWppYWB3dic%2FcXdwYHgl';
    }
    ...
    return (
        <div>
            ...
            <div class="row">
                <div class="col-sm-7">
                    <h3 className='boatPrice'>£{data.price}</h3>
            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <p className='boatDescription'>{data.description}</p>
